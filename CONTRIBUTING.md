...
**Use the GitHub Issue Templates**: When reporting bugs, please use the [Bug Report template](../../issues/new?assignees=&labels=bug&template=bug_report.yml&title=%5BBUG%5D+) which will guide you through providing all necessary information.
...
**Use the GitHub Issue Templates**: For feature requests, please use the [Feature Request template](../../issues/new?assignees=&labels=enhancement&template=feature_request.yml&title=%5BFEATURE%5D+) to explain your needs.
...
For performance-related problems, use the [Performance Issue template](../../issues/new?assignees=&labels=performance&template=performance_issue.yml&title=%5BPERFORMANCE%5D+) which collects:
...
To report documentation problems or suggest improvements, use the [Documentation template](../../issues/new?assignees=&labels=documentation&template=documentation.yml&title=%5BDOCS%5D+) for:
